...
class Engine:
    ...
    def create_assets(self,scene):
        ...
        self.shaderPlain = self.createShader(
            "shaders\\plain_vertex.txt", 
            "shaders\\plain_fragment.txt"
        )

    def set_onetime_uniforms(self):


        glUseProgram(self.shaderPlain)
        ...
        glUniformMatrix4fv(
            glGetUniformLocation(self.shaderPlain, "projection"), 
    ...
    def get_uniform_locations(self):
        ...
        glUseProgram(self.shaderPlain)
        self.earthmodelMatrixLocation = glGetUniformLocation(self.shaderPlain, "model")
        self.earthviewMatrixLocation = glGetUniformLocation(self.shaderPlain, "view")
    ...
    def quit(self):
        ...
        glDeleteProgram(self.shaderPlain)
